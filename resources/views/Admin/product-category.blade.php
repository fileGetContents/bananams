...
<div>
    <div class="pd-20">
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">
                <a class="btn btn-primary radius" onclick="product_add('添加产品','product-category-add')"
                   href="javascript:;">
                ...
                @foreach($room as $value)
                    <tr class="text-c va-m">
                        ...
                        <td><a onClick="product_show('','product-show','10001')" href="javascript:;">
                                <img width="60" class="product-thumb" src="{{asset($value->room_image)}}">
                            </a>
                        </td>
                        <td class="text-l">{{$value->room_name}}</td>
                        <td class="text-l">{{$value->hotel_name}}</td>
                        <td><span class="price">{{$value->hotel_address}}</span></td>
                        <td class="td-status">
                            {{$value->room_num}}
                        </td>
                        <td class="td-manage">
                            ...
                            <a style="text-decoration:none" class="ml-5"
                               onClick="product_del(this,'{{$value->room_id}}')"
