...
<body>
<div class="pd-20">
    <form action="{{URL('product-category-add')}}" enctype="multipart/form-data" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>房间：</label>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" name="room_price" id="" value="" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">剩余房间数目:</label>
            <div class="formControls col-10">
                <input type="text" name="room_num" id="" value="" class="input-text">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-2">酒店:</label>
            <div class="formControls col-10">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <div class="uploader-thum-container">
                    ...
                    <input value="上传文件" type="file"  name="file2"/>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#add_time").click(function () {
            $(this).prev().children().eq(0).append('<tr><td>开始时间:</td><td><input name="start[]" type="datetime-local"/></td><td>结束时间:</td><td><input name="over[]" type="datetime-local"/></td> <td>周几:</td> <td><select name="week[]" id=""><option value="星期一">星期一</option><option value="星期二">星期二</option><option value="星期三">星期三</option><option value="星期四">星期四</option> <option value="星期五">星期五</option><option value="星期六">星期六</option><option value="星期日">星期日</option></select></td></tr>')
        });
